...
This plugin provides emacs keybindings and workflow for Visual Studio Code and is a fork of [SebastianZaha fork](https://github.com/SebastianZaha/vscode-emacs-friendly) of the great vscode extension by [hiro-sun](https://github.com/hiro-sun/vscode-emacs). Which changes the meta key to CMD instead of ALT.
